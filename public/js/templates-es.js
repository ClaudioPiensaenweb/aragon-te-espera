...
function checkNoindex() {
    ...
    if (slug === '') slug = '/';
    fetch('http://localhost:8055/items/seo?fields=seo_data&filter[slug][_eq]='+encodeURIComponent(slug)+'&filter[language][_eq]=es&limit=1',{headers:{'Authorization':'Bearer aragon-admin-token'}})
